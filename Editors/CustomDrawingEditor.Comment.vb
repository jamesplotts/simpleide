...
' Replace: SimpleIDE.Editors.CustomDrawingEditor.ToggleCommentBlock
''' <summary>
        ...
        For i As Integer = lStartLine To lEndLine
            If i >= 0 AndAlso i < pLineCount Then
                ...
                If lNewLine <> lLine Then
                    pTextLines(i) = lNewLine
                    pLineMetadata(i).MarkChanged()
                    
                    ' Re-process line formatting for syntax highlighting
        ...
        Public Sub SquareSelection() Implements IEditor.SquareSelection
            Try
                ...
                ElseIf lEndLine < pLineCount - 1 Then
                    ...
                    pSelectionEndColumn = 0
                Else
                    ' Last line - extend to end of line
                    pSelectionEndLine = lEndLine
